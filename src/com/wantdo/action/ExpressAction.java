...
public class ExpressAction extends ActionSupport {
	...
	public String execute() {
		...
		try {
			if (sendupload != null) {
				...
				if (Arrays.equals(excelUtil.getRowData(0, 0), excHeader)) {
					list = ExCompany
					...
					for (int i = 0; i < threads.length; ++i) {
						...
						.equals(excelUtil.getRowData(0, 0), excHeader2)) {
					list = ExCompany
							.getEnByCn(excelUtil.getRowAndColData(0, new int[] {
			...
			/*if (Arrays.equals(excelUtil.getRowData(0, 0), excHeader)
					|| Arrays.equals(excelUtil.getRowData(0, 0), excHeader2))
		...
		if (Arrays.equals(excelUtil.getRowData(0, 0), excHeader)) {
			...
			return SUCCESS;
		} else if (Arrays.equals(excelUtil.getRowData(0, 0), excHeader2)) {
			System.out.println(excSucList);
			System.out.println(excErrList);
			if (!excSucList.isEmpty()) {
				excSucName = new SimpleDateFormat("MM_dd_HH_mm")
	...
	public static void setExcHeader(String[] excHeader) {
		ExpressAction.excHeader = excHeader;
	}
	...
	public static void setDisplayCol(int[] displayCol) {
		ExpressAction.displayCol = displayCol;
	}
	...
	public static void setExcHeader2(String[] excHeader2) {
		ExpressAction.excHeader2 = excHeader2;
	}
	...
	public static void setDisplayHeader2(String[] displayHeader2) {
		ExpressAction.displayHeader2 = displayHeader2;
	}
	...
	public static void setDisplayCol2(int[] displayCol2) {
		ExpressAction.displayCol2 = displayCol2;
	}
